...
\section{Conclusion}
With increasing number of users and devices, BDrive and any common cloud storage system faces scalability issues that are automatically givne when using RSA cryptography. While using end-to-end encryption it is hard to hold different file sin sync. \todo[inline]{short conclusion}
