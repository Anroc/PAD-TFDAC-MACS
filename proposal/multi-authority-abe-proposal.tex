...
\linespread{1.04} % Line spacing - Palatino needs more space between lines
...
\fancyhead[C]{Multi-Authority ABE for Bdrive$\bullet$ August 2018 $\bullet$ Vol. I, No. 1} % Custom header text
