...
\include{./content/05-background-bdrive}

\include{./content/06-requirements}

% Secure group communication
\include{./content/07-secure-group-communication}

% ABE
\include{./content/08-introducation-to-the-field-of-attribute-based-encryption}
