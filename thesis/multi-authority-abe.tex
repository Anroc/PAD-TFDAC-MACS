...
\thesistitle{Practical MA-ABE for Secure Cloud Storage Systems} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\group{\href{https://dsi.tu-berlin.de}{Network security}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
\faculty{\href{https://www.eecs.tu-berlin.de/menue/fakultaet_iv/?no_cache=1}{Faculty 4}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
