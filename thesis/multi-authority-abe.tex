...
% ABE
\input{./content/09-basic-attribute-based-encryption}

% MA-ABE
\input{./content/10-multi-authority-attribute-based-encryption}

% Implementation
\input{./content/11-concept-and-implementation}
