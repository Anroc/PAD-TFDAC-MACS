...
To compare the sub topics of MA-ABE we need to extend the charm framework with an implementation of DABE, HABE and TF-DAC-MACS. DAC-MACS on the other hand exisited in the farmework already. 
