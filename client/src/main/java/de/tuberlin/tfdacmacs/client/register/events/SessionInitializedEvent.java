...
@Getter
public class SessionInitializedEvent extends ApplicationEvent {

    private final Certificate certificate;
    private final KeyPair keyPair;

    public SessionInitializedEvent(@NonNull String email, @NonNull Certificate certificate, KeyPair keyPair) {
        super(email);
